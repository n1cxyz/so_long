...
gcc -g -o so_long_bonus so_long_bonus.c -L./mlx_linux -lmlx -lX11 -lXext -I./libft -L./libft -lft
gcc -g -o so_long so_long.c -L./mlx_linux -lmlx -lX11 -lXext -I./libft -L./libft -lft
